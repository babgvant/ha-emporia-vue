...
action adds the monitor's eligible branch circuits, including circuits from
nested subpanels. A nested EVSE is added as one discrete circuit using its main
total. It skips other panel totals,
